---
name: aco-organization-office
description: "Research-led organizational strategy, culture, programmes, publishing, partnerships and operations."
---

# Aco Organization Office
...
The lead role is `organization_orchestrator` (native Codex name: `aco_organization_orchestrator`). Read its full instructions using the catalogue; do not rely only on its title.
