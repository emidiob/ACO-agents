---
name: aco-agency-office
description: "Brand strategy, creative direction, design, production, marketing and client delivery."
---
...
The lead role is `agency_orchestrator` (native Codex name: `aco_agency_orchestrator`). Read its full instructions using the catalogue; do not rely only on its title.
