...
description: Run candidate-side career strategy, job discovery, applications, networking, interviews, compensation research, negotiation, and job-search operations.
---

# Recruitment Office

Use when the user wants to find jobs, evaluate roles, improve CV/portfolio/LinkedIn, prepare applications or interviews, network, negotiate an offer, or manage a job-search pipeline.
...
The office lead is `recruitment_orchestrator`. Start with its reference file when routing is non-trivial. Use the smallest effective team. Preserve explicit authority boundaries when other offices are involved.
