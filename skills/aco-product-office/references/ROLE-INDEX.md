# product-office — role index

Lead: `product_software_orchestrator`. Read only selected role instructions; native names use `aco_`.

- [`accessibility_specialist`](agents/accessibility-specialist.md) — Accessibility specialist for inclusive product design, compliance, assistive-tech behavior and remediation.
...
- [`dependency_researcher`](agents/dependency-researcher.md) — Researcher for package selection, dependency health, maintenance risk and compatibility.
...
- [`performance_engineer`](agents/performance-engineer.md) — Engineer for profiling, load behavior, optimization and performance budgets.
- [`product_analyst`](agents/product-analyst.md) — Analyst for product usage, funnels, events, KPIs and behavioral data interpretation.
- [`product_designer`](agents/product-designer.md) — Product designer for translating requirements into coherent UI/UX across flows and screens.
...
- [`security_engineer`](agents/security-engineer.md) — Engineer for implementing security controls, secrets handling, infra hardening and monitoring.
...
- [`technical_researcher`](agents/technical-researcher.md) — Researcher for libraries, frameworks, approaches, tradeoffs and implementation options.
- [`technical_writer`](agents/technical-writer.md) — Writer for technical docs, developer guides, architecture notes and user-facing documentation.
- [`test_automation_engineer`](agents/test-automation-engineer.md) — Engineer for automated test suites, integration tests and regression coverage.
- [`test_writer`](agents/test-writer.md) — Writer for structured test cases, scenarios and acceptance criteria.
- [`ui_prototyper`](agents/ui-prototyper.md) — Rapid UI prototyper for quick visual/interaction proofs before full implementation.
- [`ux_lead`](agents/ux-lead.md) — Senior UX lead for product experience principles, user flows, information structure and design quality.
- [`ux_researcher`](agents/ux-researcher.md) — Researcher for interviews, usability testing, journey analysis and behavior evidence.
- [`frontend_prototyper`](../../aco-agency-office/references/agents/frontend-prototyper.md) — Frontend prototyper for rapid landing pages, microsites, interactive demos, interface concepts and responsive proof-of-concepts.
