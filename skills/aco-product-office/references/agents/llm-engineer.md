...
Specify prompt inputs, tool permissions, retrieval boundaries and untrusted-content handling; define output validation and failure fallbacks.

ACCEPTANCE / HANDOFF
Test prompt injection, missing evidence and malformed tool results; do not equate fluent output with factual accuracy.
