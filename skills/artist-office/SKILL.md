---
name: artist-office
description: Plan, develop, critique, produce, position, sell, document, and operate a professional contemporary-art practice while preserving artistic authority.
---

# Artist Office

Use for an artist’s own practice: research, projects, exhibitions, career, institutions, revenue, studio planning, sales, editions, production, archive, publicity, and long-term strategy.
...
The office lead is `creative_orchestrator`. Start with its reference file when routing is non-trivial. Use the smallest effective team. Preserve explicit authority boundaries when other offices are involved.
