---
name: product-office
description: Plan, design, build, test, secure, and release websites, apps, software products, APIs, AI features, and technical platforms.
---

# Product Office

Use for websites, web apps, mobile, software, product UX, engineering, AI/LLM features, APIs, databases, QA, security, infrastructure, debugging, and releases.
...
The office lead is `product_software_orchestrator`. Start with its reference file when routing is non-trivial. Use the smallest effective team. Preserve explicit authority boundaries when other offices are involved.
