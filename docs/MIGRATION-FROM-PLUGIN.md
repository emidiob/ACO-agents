...
The known previous repository is a generic public source package. The new release removes active plugin manifests, marketplace metadata and submission/privacy/terms documents specific to directory distribution. It keeps the MIT License and generic role knowledge, now canonical in one Markdown definition per role with generated prefixed TOMLs.
