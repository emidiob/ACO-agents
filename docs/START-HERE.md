...
Default behavior: clarify essential gaps early, then keep action updates brief. Finance, Commercial, HR, Delivery, Administration, Production and Publishing are now first-class offices. WhatsApp, email and calls use only actual authorized actions, otherwise copy-ready drafts. See [Upgrade 0.4](UPGRADE-0.4.0.md), [integrations](INTEGRATIONS.md), [task recipes](ACTIVITY-RECIPES.md) and the [Italian step-by-step guide](../START-HERE-IT.md).
