# Upgrade to ACO v0.5.2

This is a resource/method expansion over v0.5.1. Compact Memory and Pipeline != Project remain unchanged.

## Changes
- 62 optional resources (22 new).
- 47 workflows (9 new).
- New original ACO playbooks for action-first output, human writing review, code/API references, AI workflow builders, SEO, research notebooks, monitoring, whiteboarding, secrets boundaries, file/media handling, career documents, web extraction and external software-agent execution.
